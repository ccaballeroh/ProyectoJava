...
public class Prueba {
  public static void main(String s[]){
    ...
    uno.modeloER(237);
    uno.escribirArchivo("Salidas\\GV\\Salida1.gv");

    Grafo dos = new Grafo(589);
    dos.modeloER(500);
    uno.escribirArchivo("Salidas\\GV\\Salida2.gv");

    Grafo tres = new Grafo(1500);
    tres.modeloER(1289);
    tres.escribirArchivo("Salidas\\GV\\Salida3.gv");

    Grafo cuatro = new Grafo(358);
    cuatro.modeloGilbert(1);
    cuatro.escribirArchivo("Salidas\\GV\\Salida4.gv");

    Grafo cinco = new Grafo(589);
    cinco.modeloGilbert(0.3);
    cinco.escribirArchivo("Salidas\\GV\\Salida5.gv");

    Grafo seis = new Grafo(1500);
    seis.modeloGilbert(0.05);
    seis.escribirArchivo("Salidas\\GV\\Salida6.gv");

    Grafo siete = new Grafo(358, "geo-uniforme");
    siete.modeloGeoSimple(1);
    siete.escribirArchivo("Salidas\\GV\\Salida7.gv");

    Grafo ocho = new Grafo(589, "geo-uniforme");
    ocho.modeloGeoSimple(.5);
    ocho.escribirArchivo("Salidas\\GV\\Salida8.gv");

    Grafo nueve = new Grafo(1500, "geo-uniforme");
    nueve.modeloGeoSimple(0.1);
    nueve.escribirArchivo("Salidas\\GV\\Salida9.gv");
